...
/*    public static void main(String[] arg) {
    ...
    public String getDateStringExt() {
        String str = "农历" + animalNames[(chineseYear-1)%12]+"年";

        str += chineseMonthNames[(chineseMonth-1)%12]+"月";
        str += chineseDayNames[(chineseDate-1)%30];
